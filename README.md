...
The C program to upload Basic code was developed using the Code::Blocks IDE as a Windows console program. For some reason, upload fails after about 2,000 characters of Basic code are transmitted, and I could not track down the cause, so the code had to be stripped down to under that.
