100 "SIZE"; :REM modified from TB Game of Life posted in http://www.ittybittycomputers.com/ittybitty/tinybasic/
105 F=0
110 INPUT A :REM size of board, add boundary cells
115 B=A+2 :REM DIM G(),H()=(B,B)
116 G=4000  :REM arrays begin in unused RAM
117 H=G+B*B
120 Z=0  
140 I=1
141 J=1 :REM I,J=1 TO B
155 GOSUB 7170 :REM G, H()=Z (0)
158 GOSUB 7760
160 J=J+1
161 IF J<=B GOTO 155
170 I=I+1
...
200 INPUT K :REM one entry per line
210 IF K<2 GOTO 220
212 J=M
214 GOTO 230
220 Z=K 
